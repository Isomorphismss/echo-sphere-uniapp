		...
		<view class="myInfo">
			...
			<view class="msg-list-box" @click="showPlusBox = false" >
				...
				<view v-if="chatMsgList.length > 0" class="block-me" :style="{'height': chatListPaddingTop + 'px'}">
					<image v-if="chatMsgList.length > 0 && showMe" class="show-me" src="../../static/images/camera.png"></image>
				</view>
				...
				<view
					...
					<view class="chat-cover-wrapper">
						<image class="chat-cover" src="../../static/icons/wechat/icon-search.png"></image>
					</view>
