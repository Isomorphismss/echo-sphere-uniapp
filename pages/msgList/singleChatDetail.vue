...
<template>
	<view>
		<view class="top-box">
			<view class="one-user">
				<image src="../../static/images/default.png" class="face"></image>
				<text class="nickname" style="">Isomorphism</text>
			</view>
		...
		<view class="block-one" style="margin-top: 20upx;">
			<view class="block-box">
				<view
					:class="{'item-line-notouch':true, 'item-line-touched': false, 'block-line': true}"
					@click="goToChatBG()">
					<view class="right-part" style="line-height: 55px;">
