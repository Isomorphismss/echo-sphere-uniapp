		...
		<view class="myInfo">
			...
			<view class="letter-words-box">
				<view class="letter-words-list">
					<image src="../../static/icons/wechat/icon-search.png" class="letter-icon" v-if="env == 'iso'"></image>
			...
			<view class="msg-list-box">
				...
				<view v-if="contactList.length > 0" class="block-me" :style="{'height': chatListPaddingTop + 'px'}">
					<image v-if="contactList.length > 0 && showMe" class="show-me" src="../../static/images/camera.png"></image>
				</view>
				
				<view class="search-box" v-if="env == 'iso'">
					<view class="search-wrapper">
						<view class="search-middle">
							<image class="icon-search" src="../../static/icons/wechat/icon-search.png"></image>
